...
/*   Updated: 2023/09/06 04:52:20 by djonker      \___)=(___/                 */
/*                                                                            */
/* ************************************************************************** */
...
// parseglobs should keep a counter of where in the pipeline we are.
// when it finds a glob it sends the position to the corresponding glob parser
// it parses the glob gives back the glob position + lenght of parsed glob.
// if it encounters another glob it should test all possibilities in some way
// parseglobs goes on.
