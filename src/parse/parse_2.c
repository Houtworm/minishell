...
/*   Updated: 2023/08/25 19:52:54 by yitoh         ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
// 		forks[i].cmds = ft_exec_strct(forks[i].pipeline, shell);
// 		i++;
// 		shell->forkamount++;
// 	}
// 	return (forks);
...
// t_cmds	*ft_exec_strct(char *pipeline, t_shell *shell)
// {
// 	t_cmds	*cmd;
// 	char	**paths;
// 	int		i;
...
// 	cmd = ft_calloc(count_str2(pipeline) + 1, sizeof(t_cmds));
// 	if (!cmd)
// 		ft_errorexit("Error allocating memory", "malloc", 1);
// 	i = 0;
// 	while (i < count_str2(pipeline))
// 	{
// 		k = 0;
// 		while (pipeline[k])
// 		{
